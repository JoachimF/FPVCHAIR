 ...
 */
 ...
 #define TQS_I2C_ADDRESS                    0x08
 #define ADS1115_RESOLUTION 15 //bits, min 12, max 15

// <TQS>

  #define TQS_INVERT_TH 0
  #define TQS_INVERT_ANT 0
...
// <CYCLIC>
  ...
  #define PSEUDO_FORCE_TRIM_BUTTON 0
  // this will disable a choosen button and dedicate it to force trim. Top button in Huey, mid button in 407
  #define PSEUDO_FORCE_TRIM_EFFECTS_PEDALS 0 //in a real heli force trim affects both cyclic and pedals, this is a default behavior
...
// <COLLECTIVE>
  ...
  #define DCS_HUEY_IDLE_STOP_COMPAT_MODE_ENABLED 0 // ASSIGN IDLE STOP IN_GAME WHILE IN MODE 0 (MODE SWITCH CENTERED)!
